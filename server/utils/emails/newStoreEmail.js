exports.NewStoreEmailPending = (_bodyData) => {
  return `
  <!DOCTYPE html>
<html
                      ...
                      >
                        <tbody>
                          <tr>
                            ...
                            >
                              <a
                                href="http://localhost:3000/storeAdmin"
                                target="_blank"
                                style="
                                  -ms-text-size-adjust: 100%;
                                  -webkit-text-size-adjust: 100%;
...
exports.NewStoreEmailActive = (_bodyData) => {
  return `
  <!DOCTYPE html>
<html
  xmlns="http://www.w3.org/1999/xhtml"
                            ...
                            <img
                              ...
                              >
                                <span
                                  class="highlighted-text"
                                  style="color: #000"
                                  >Your store has been approved</span
                                >
                              </h1>
                            </td>
                          </tr>
                          <tr>
                            ...
                            >
                              <p
                                ...
                                "
                              >
                                Hii ${_bodyData.name} Your store now is ACTIVE, you can sell
                                products add products to your store & edit &
